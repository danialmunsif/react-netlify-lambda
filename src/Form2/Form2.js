...
const validationSchema = Yup.object().shape({
  ...
  client1Phone: Yup.number().typeError("Client Phone 1 should be a number"),
...
class Form2 extends React.Component {
  ...
  exportPdf = () => {
    ...
    htmlToPDF.html(ReactDOMServer.renderToStaticMarkup(this.formData()), {
      callback: function (htmlToPDF) {
        htmlToPDF.save("specter-finance.pdf");
      },
    });
    // }
  ...
  exportWord = () => {
    ...
    saveAs(docx, "specter-finance.docx");
  };
                  ...
                  <div className='form-sub-cont'>
                    ...
                    <div className='form-input-cont' style={{ margin: 0 }}>
                      <label className='pure-material-textfield-outlined'>
                        ...
                        />
                        <span
                        // style={this.state.client1NameEmpty ? { color: 'red' } : null}
                        >
                          {/* {this.state.client1NameEmpty ? 'field is required*' : 'Client Name'} */}
                          Client Name
                        </span>
                      </label>
                      <label className='pure-material-textfield-outlined'>
